...
sim_results_mat = {fullfile(Basedir,'Sim_55_results','60_subjects','Sim_55_60_subjects.mat'), ...
		   ...
		   fullfile(Basedir,'Sim_38_results','480_subjects','Sim_38_480_subjects.mat'); ...
		   ...
		   fullfile(Basedir,'Sim_49_results','480_subjects','Sim_49_480_subjects.mat'); ...
...
results_params = struct('nom_80_results', struct('nominal_level', nominal_levels(1), ...
                                                 ...
                                                 'ThreeD_sig_2_t_bootstrap_results', sim_covering_levels_and_subs(:,:,1,1),  ...
                                                 'ThreeD_sig_2_old_bootstrap_results', sim_covering_levels_and_subs(:,:,2,1), ...
                                                 'TwoD_sig_2_t_bootstrap_results', sim_covering_levels_and_subs(:,:,3,1),  ...
                                                 'TwoD_sig_2_old_bootstrap_results', sim_covering_levels_and_subs(:,:,4,1)),  ...
                        'nom_90_results', struct('nominal_level', nominal_levels(2), ...
                                                 'nominal_prct_level', nominal_prct_levels(2), ...
                                                 'std_error', std_error_vector(2), ...
                                                 'ThreeD_sig_2_t_bootstrap_results', sim_covering_levels_and_subs(:,:,1,2), ...
                                                 'ThreeD_sig_2_old_bootstrap_results', sim_covering_levels_and_subs(:,:,2,2), ...
                                                 'TwoD_sig_2_t_bootstrap_results', sim_covering_levels_and_subs(:,:,3,2),  ...
                                                 'TwoD_sig_2_old_bootstrap_results', sim_covering_levels_and_subs(:,:,4,2)),  ...
                        'nom_95_results', struct('nominal_level', nominal_levels(3), ...
                                                 'nominal_prct_level', nominal_prct_levels(3), ...
                                                 'std_error', std_error_vector(3), ...
                                                 'ThreeD_sig_2_t_bootstrap_results', sim_covering_levels_and_subs(:,:,1,3), ...
                                                 'ThreeD_sig_2_old_bootstrap_results', sim_covering_levels_and_subs(:,:,2,3), ...
                                                 'TwoD_sig_2_t_bootstrap_results', sim_covering_levels_and_subs(:,:,3,3), ...
                                                 'TwoD_sig_2_old_bootstrap_results', sim_covering_levels_and_subs(:,:,4,3)) ...                                                                                               
                        );
