...
x.percentage_success_vector_observed_95 = mean(x.subset_success_vector_raw_95, 1);
x.percentage_success_vector_raw_95 = mean(x.subset_success_vector_observed_95, 1);
