...
true_boundary_subset_params = getBdryparams(Sig, thr, 0, 1); 
...
for t=1:nRlz
    ...
    observed_mean_boundary = getBdryvalues(observed_mean, true_boundary_subset_params, 0); 
    ...
    lower_condition_80_boundary = getBdryvalues(lower_condition_80, true_boundary_subset_params, 0);
    upper_condition_80_boundary = getBdryvalues(upper_condition_80, true_boundary_subset_params, 0);
    lower_condition_90_boundary = getBdryvalues(lower_condition_90, true_boundary_subset_params, 0);
    upper_condition_90_boundary = getBdryvalues(upper_condition_90, true_boundary_subset_params, 0);
    lower_condition_95_boundary = getBdryvalues(lower_condition_95, true_boundary_subset_params, 0);
    upper_condition_95_boundary = getBdryvalues(upper_condition_95, true_boundary_subset_params, 0);
    
    lower_condition_80_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) < lower_condition_80_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    upper_condition_80_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) >= upper_condition_80_boundary(true_boundary_subset_params.lshift.w1 ~= 1);                              
    lower_condition_90_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) < lower_condition_90_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    upper_condition_90_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) >= upper_condition_90_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    lower_condition_95_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) < lower_condition_95_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    upper_condition_95_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) >= upper_condition_95_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    ...
    lower_condition_80_observed_boundary = getBdryvalues(lower_condition_80_observed, true_boundary_subset_params, 0);
    upper_condition_80_observed_boundary = getBdryvalues(upper_condition_80_observed, true_boundary_subset_params, 0);
    lower_condition_90_observed_boundary = getBdryvalues(lower_condition_90_observed, true_boundary_subset_params, 0);
    upper_condition_90_observed_boundary = getBdryvalues(upper_condition_90_observed, true_boundary_subset_params, 0);
    lower_condition_95_observed_boundary = getBdryvalues(lower_condition_95_observed, true_boundary_subset_params, 0);
    upper_condition_95_observed_boundary = getBdryvalues(upper_condition_95_observed, true_boundary_subset_params, 0);

    lower_condition_80_observed_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) < lower_condition_80_observed_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    upper_condition_80_observed_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) >= upper_condition_80_observed_boundary(true_boundary_subset_params.lshift.w1 ~= 1);                              
    lower_condition_90_observed_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) < lower_condition_90_observed_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    upper_condition_90_observed_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) >= upper_condition_90_observed_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    lower_condition_95_observed_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) < lower_condition_95_observed_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
    upper_condition_95_observed_success = observed_mean_boundary(true_boundary_subset_params.lshift.w1 ~= 1) >= upper_condition_95_observed_boundary(true_boundary_subset_params.lshift.w1 ~= 1);
