...
x.percentage_success_vector_cohen_d_80 = mean(x.subset_success_vector_cohen_d_80, 1); 
x.percentage_success_vector_cohen_d_90 = mean(x.subset_success_vector_cohen_d_90, 1);
x.percentage_success_vector_cohen_d_95 = mean(x.subset_success_vector_cohen_d_95, 1);
...
x.percentage_success_vector_cohen_d_80_alternate = mean(x.subset_success_vector_cohen_d_80_alternate, 1); 
x.percentage_success_vector_cohen_d_90_alternate = mean(x.subset_success_vector_cohen_d_90_alternate, 1);
x.percentage_success_vector_cohen_d_95_alternate = mean(x.subset_success_vector_cohen_d_95_alternate, 1);
